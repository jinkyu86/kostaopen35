...
public class MemberBetDataDAO {
	...
	public static ArrayList<MemberBetData> selectMemberBetDataListByID(
			int page, int length, String ID1) {
	...
	// 매치 넘버를 조회하는 메서드
	public static String selectMatchNum(String num) {
		Connection con = null;
		PreparedStatement psmt = null;
		String sql = null;
		ResultSet rs = null;
	...
	public static MemberBetData selectMemberBetData(String num) {
