...
public class ChangeDAO {
	...
	public static void completeChange(int agreeBoardNo, int demandBoardNo){
		Connection con=null;
		PreparedStatement ps1=null;
		PreparedStatement ps2=null;
		...
		try {
			...
			ps1=con.prepareStatement("Update tb_change set condition_result=3 where demand_board_no=? " +
					"or agree_board_no=?");
			ps2=con.prepareStatement("Update tb_board set condition_result=3 where board_no=? or board_no=?");
			
			ps1.setInt(1, agreeBoardNo);
			ps1.setInt(2, agreeBoardNo);
			ps2.setInt(1, agreeBoardNo);
			ps2.setInt(2, demandBoardNo);
