...
<body>
	...
	<form action="/auction/addGood.action" method="post" id="my_form">
		...
		<center>
			<input type="submit" value="물건 등록" /> <input type="reset"
				value="입력취소" />
		</center>
	</form>
	<p align="center">
		<a href="/auction/viewGoodList.action"> <img
			src="/auction/menu/viewGoodList.jpg" />
		</a>
	</p>
		</p>
	</section>			
