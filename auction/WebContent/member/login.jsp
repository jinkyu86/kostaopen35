		...
		<header>
			...
			<li><c:choose>
					<c:when test="${sessionScope.MEMBER==null}">
						<p align="right">
							<a><font color=black>로그인</font></a>
							</br> 
							<a> <font color=black>회원가입</font>
						</a>
						</p>
					</c:when>
					<c:otherwise>
		...
		<nav>
			...
			<div class="menu">
				<ul>
					...
					<li><a href="/auction/viewAuctionList.action"> 
							<font color=white>경매 보기</font>
							</a></li>
