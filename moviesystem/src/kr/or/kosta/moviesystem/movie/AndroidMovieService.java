...
public class AndroidMovieService implements ModelDriven,ServletContextAware,ServletRequestAware,
ServletResponseAware,SessionAware,IService{
	...
	public AndroidMovieService(IMovieDAO movieDAO) {
		super();
		//System.out.println("movieDAO확인");
		this.movieDAO = movieDAO;
	}

	public AndroidMovieService() {
        super();
	...
	public String viewMovieList() throws Exception {
		...
		JSONObject jsonObject = new JSONObject();
		JSONArray movieList =JSONArray.fromObject(MOVIE_LIST);
		jsonObject.put("MOVIE_LIST", movieList);
		String resultString = jsonObject.toString();
